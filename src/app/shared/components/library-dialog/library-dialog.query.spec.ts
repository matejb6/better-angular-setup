...
export const getDialogContentDescription = (
  parentElem: HTMLElement,
): HTMLParagraphElement | null | undefined => {
  return getDialogContent(parentElem)?.querySelectorAll('p').item(0);
};

export const getDialogContentDescriptionList = (
  parentElem: HTMLElement,
): HTMLUListElement | null | undefined => {
